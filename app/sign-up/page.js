    ...
    return (
        <div className="bg-[#46708D] h-screen w-screen flex flex-col justify-center items-center">
            ...
            <main className="items-center flex flex-col mb-40">
                ...
                <button className="bg-white text-black font-bold p-2 rounded-md mt-5 w-30 flex items-center justify-center">
                    SIGN IN
                    <Image src="/assets/7123025_logo_google_g_icon.png" alt="Google Icon" width={36} height={36} className="ml-2" />
                </button>
            </main>
        </div>
    );
